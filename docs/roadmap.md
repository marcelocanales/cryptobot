...
| **Filtrar por liquidez real antes de evaluar un ciclo** | Que un triángulo exista matemáticamente (o que un par cotice en dos exchanges) no significa que tenga profundidad real en todas sus patas. La Etapa 2 necesita un paso previo de filtrado por liquidez real antes de calcular spreads — si no, se "detectan" oportunidades que no se pueden ejecutar al tamaño necesario. Aplica a más de una estrategia, es un paso de metodología, no de una estrategia puntual. | [Sprint 0001](sprints/sprint_0001.md), leyendo [triangular-intra-exchange](estrategias/02-triangular-intra-exchange.md) |
