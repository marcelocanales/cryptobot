# Hub Documental — Cryptobot

Índice maestro del proyecto. Cada línea apunta a un documento con una descripción de una línea. Punto de entrada en Obsidian y Quartz.

> Cargar los documentos según la tarea — no cargar todo junto.
...
| [etapa3-plan.md](etapa3-plan.md) | Las 4 fases de la Etapa 3 — de conectar un exchange hasta una prueba real mínima |
